  ...
  return (
    <div className="third-service-wrapper">
      <div className="left-service-section-02">
        ...
        <Chapter
          label={"Witness a remarkable improvement"}
          paragraph={
            "Although not a permanent solution, our Cupping Services deliver a dramatic enhancement that may last several weeks."
          }
        />
        <Chapter
          label={"Unlike other companies"}
          paragraph={
            "We clarify that these services are temporary, ensuring a transparent and honest service experience. Perfect for that vacation or event coming up where you need a quick boost!"
          }
        />
        <Chapter
          label={"For enduring results"}
          paragraph={
            "We recommend complementing our cupping services with permanent treatments like our RF Skin Tightening and Fat Freezing Services."
          }
        />
