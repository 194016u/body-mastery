    ...
    <div className="card-section-wrapper">
      ...
      <div className="card-section-part">
        ...
        <Card
          ...
          label={"Daniella Z."}
          paragraph={
            "You're a priority in their care. They run this out of their home, so it feels very cozy and intimate. Thank you for the attention with each service Marianne!"
          }
        />
        ...
        <Card
          ...
          label={"Margaret B."}
          paragraph={
            "I was very skeptical that I would see any improvement in my hair, specifically return of my hair color. It did take time but I am pleasantly surprised that my original hair color has returned. I would definitely recommend this service. My friend referred me due to her results with both the hair blossoming and radio frequency services and now I am sending my husband."
          }
        />
