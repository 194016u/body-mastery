...
export const ServiceSection = () => {
  return (
    <div className="paragraph-section-02-wrapper">
      ...
      <Chapter
        label={"Non-Invasive & Painless"}
        paragraph={
          "Say goodbye to surgical risks! Embrace a treatment that's gentle but powerful and free from the hassles of surgery and downtime."
        }
      />

      <Chapter
        label={"Safe and Proven Methodology"}
        paragraph={
      ...
      <Chapter
        label={"Nourish and Flourish"}
        paragraph={
          "Entrust your skin to expert hands, employing meticulously researched techniques to nourish your skin deeply and unveil its inherent radiance."
        }
      />
      ...
      <Chapter
        ...
        paragraph={
          "Entrust your skin to expert hands, employing meticulously researched techniques to nourish your skin deeply and unveil its inherent radiance. Unlock a new realm of self-confidence as you step out, flaunting skin that's tightened, toned and terrifically radiant!"
        }
      />
      ...
      <Chapter
        label={"Fat Freezing or Cryolipolysis"}
        paragraph={
          "Is a revolutionary procedure that targets and eliminates stubborn fat cells by freezing them. This science backed technique ensures that the fat cells under the skin are carefully crystalized and naturally eliminated by the body over time, promoting a more toned and sculpted appearance."
        }
      />
      <Chapter
        label={"Advanced Targeting"}
        paragraph={
          "The procedure selectively targets fat cells, leaving surrounding tissues untouched."
        }
      />
      <Chapter
        label={"Cellular Magic"}
        paragraph={
          "Post-treatment, the frozen fat cells die and are naturally expelled by the body over several weeks, revealing a more sculpted you."
        }
      />
      <Chapter
        label={"Temperature Precision"}
        paragraph={
          "Our technology meticulously controls the cooling process, ensuring that it is precise enough to target only the fat cells."
        }
      />
